...
import SystemLoadingAnimation from "./components/SystemLoadingAnimation";
...
function AppContent() {
  const { showOnboarding, completeOnboarding, showLogout, completeLogout, showSystemLoading, completeSystemLoading } = useAuth();

  return (
    <>
      {showSystemLoading && <SystemLoadingAnimation onComplete={completeSystemLoading} />}
