...
const DSAInterview = () => {
    ...
    const fetchSession = async () => {
        try {
            const response = await fetch(`${API_BASE_URL}/dsa-interviews/session/${sessionId}`);
    ...
    const startPreliminary = async () => {
        try {
            const response = await fetch(`${API_BASE_URL}/dsa-interviews/preliminary/start/${sessionId}`, {
                method: 'POST'
            });
            const data = await response.json();
    ...
    const completePreliminary = async (answers) => {
        try {
            const response = await fetch(`${API_BASE_URL}/dsa-interviews/preliminary/submit/${sessionId}`, {
                method: 'POST',
    ...
    const startCoding = async () => {
        try {
            const response = await fetch(`${API_BASE_URL}/dsa-interviews/coding/start/${sessionId}`, {
                method: 'POST'
            });
            const data = await response.json();
    ...
    const submitCode = async () => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/dsa-interviews/coding/submit/${sessionId}`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
    ...
    const completeInterview = async () => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/dsa-interviews/complete/${sessionId}`, {
                method: 'POST'
            });
            const data = await response.json();
    ...
    const fetchScorecard = async () => {
        try {
            const response = await fetch(`${API_BASE_URL}/dsa-interviews/scorecard/${sessionId}`);
            const data = await response.json();
